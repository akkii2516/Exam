...
//	        );
//
//	        statement.setString(1, newClassNum); // 新しいクラス番号（存在しててもOK）
//
//	        statement.setString(2, oldClassNum.getClass_num()); // 今のクラス番号
//
//	        statement.setString(3, oldClassNum.getSchool().getCd()); // 学校コード
//
//	        count = statement.executeUpdate();
//
//	    } catch (Exception e) {
