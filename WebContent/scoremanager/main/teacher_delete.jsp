...
<c:import url="/common/base.jsp">
	...
	<c:param name="content">
		<section class="me=4">
			<h2 class="h3 mb-3 fw-norma bg-secondary bg-opacity-10 py-2 px-4">ユーザー情報削除</h2>

			<form action="TeacherDeleteExecute.action" method="get">
				<div class="col-5" style="margin-left: 15px; margin-top: 30px" id="filter">
					<div class="d-flex gap-2 mb-3" style="margin-top:40px">
						<p>「${teacher.name}」を削除してもよろしいですか</p>
					</div>
